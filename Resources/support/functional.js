...
reduce=defn(function(fn,init,sequence){if(!sequence) throw("Functional.js: No list passed to reduce"); fn=Function.toFunction(fn);var len=sequence.length,result=init;for(var i=0;i<len;i++)
